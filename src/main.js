...
const cardNumberPattern = {
  ...
  dispatch: function (appended, dinamycMasked) {
    const number = (dinamycMasked.value + appended).replace(/\D/g, "")
    const foundMask = dinamycMasked.compiledMasks.find(function (item) {
